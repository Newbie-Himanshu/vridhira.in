  ...
  return (
    <Card className="overflow-hidden group hover:shadow-2xl transition-all duration-500 border-border/50 bg-white/50 backdrop-blur-sm rounded-3xl hover:-translate-y-2">
      ...
      <CardFooter className="p-6 pt-0">
        <Button className="w-full bg-secondary hover:bg-secondary/90 text-white font-bold rounded-2xl h-12 shadow-lg transition-all active:scale-95 group/btn shine-effect overflow-hidden">
