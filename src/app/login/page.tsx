    ...
    <div className="container mx-auto px-4 py-20 min-h-[calc(100vh-80px)] flex items-center justify-center">
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="space-y-6">
          ...
          <Button 
            variant="outline" 
            className="w-full h-14 rounded-2xl border-2 font-bold hover:bg-white transition-all duration-300 bg-white flex items-center justify-center text-lg animate-pulse-glow shine-effect overflow-hidden shadow-[0_0_20px_hsl(var(--primary)/0.3)]" 
              ...
              <Card className="border-none shadow-2xl bg-white/70 backdrop-blur-md rounded-3xl overflow-hidden">
                ...
                <CardContent className="space-y-4">
                  <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <Button className="w-full h-12 rounded-2xl bg-primary hover:bg-primary/90 text-white font-bold text-sm uppercase tracking-widest shadow-[0_0_25px_5px_hsl(var(--primary)/0.5)] transition-all active:scale-95 animate-pulse-glow shine-effect overflow-hidden" disabled={loading}>
